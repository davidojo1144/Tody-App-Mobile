  ...
  return (
    <SafeAreaView className="flex-1 bg-white p-5" edges={["top", "left", "right"]}>
      <View className="flex-row gap-[15%] items-center mb-6">
        ...
        <Text className="text-xl font-medium">Productivity</Text>
      </View>
      ...
      {user && (
        <View className="items-center mb-4">
          ...
          <Text className="text-md font-medium mt-1">{`${user.firstName} ${user.lastName}`}</Text>
      ...
      <View className="mb-4">
        <Text className="text-lg text-gray-700 mb-1">Report Progress</Text>
